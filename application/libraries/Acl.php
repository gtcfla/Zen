...
class ACL
{
     ...
     * @return boolean 检查结果
     */
    static public function rolesBasedCheck($roles, $acl, $skip_normalize = false)
    {
     ...
     * @return array
     */
    static public function normalize(array $acl)
    {
